...
def estimate_tau(avalanche_sizes, show_plot = False):
    x, y = logbin(avalanche_sizes, 1.2)
...
system_sizes = [16, 32, 64, 128] #exclude small system sizes to uphold large L approximations made in derivations
...
for tau in tau_range:
    for L in system_sizes:
        x, y = logbin(avalanche_sizes_dict[L], scale = 1.3, zeros = False)
